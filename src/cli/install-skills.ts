 ...
 *
 * Lists the Claude skills bundled with this package (one per Lyzr capability:
 * agents, knowledge base, knowledge graph, memory, scheduler, guardrails,
 * credentials) and lets the user pick which ones to drop into their project's
...
const readFrontmatter = (path: string): Record<string, string> => {
...
const discoverSkills = (): SkillInfo[] =>
...
const install = (skill: SkillInfo, targetRoot: string): void => {
