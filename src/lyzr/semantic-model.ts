...
export class SemanticModelClient extends LyzrHttp {
  ...
  /** List table names for a connected database. GET /v3/semantic_model/list_tables/{rag_config_id}/{database_id} */
  listTables(
    ragConfigId: string,
    databaseId: string,
    signal?: AbortSignal,
  ...
  /** Preview a table's rows. GET /v3/semantic_model/table_preview/{rag_config_id}/{database_id}/{table_name} */
  getTablePreview(
    ragConfigId: string,
    databaseId: string,
    tableName: string,
  ...
  /** Get saved table/column descriptions. GET /v3/semantic_model/descriptions/{rag_config_id}/{database_id}/{table_name} */
  getDescriptions(
    ragConfigId: string,
    databaseId: string,
    tableName: string,
    ...
    return this.request<TableColumnDescriptions>(
      "GET",
